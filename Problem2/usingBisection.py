...
a year. What is a reasonable lower bound for this payment value? $0 is the obvious anwer, but you can do better than that. 
...
while abs(bal) > 0.01:
        bal = balance
        lowestPay = (monthlyPaymentLowerBound + monthlyPaymentUpperBound) / 2
        for i in range(1,13):
